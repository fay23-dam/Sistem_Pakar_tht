...
public class DaftarPenyakitActivity extends AppCompatActivity {
    ...
    com.azhar.spks.database.DatabaseHelper databaseHelper;
    ArrayList<com.azhar.spks.model.ModelDaftarPenyakit> modelDaftarPenyakitList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set database
        databaseHelper = new com.azhar.spks.database.DatabaseHelper(this);
